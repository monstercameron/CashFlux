...
- [x] **C290 [MAJOR]** ~~No About/Privacy page/route~~ **— RESOLVED (2026-06-27):** `internal/screens/about.go` replaces the stub; `About()` in `help.go` now calls `AboutScreen()`. The /about route (already registered) renders five cards: app identity, Privacy & your data (local-first, no tracking, export), Cloud sync disclosure, AI-key disclosure, Version & changelog. 25 i18n keys in `internal/i18n/en_about.go`. Wasm rc=0. Footer link to /about remains a follow-on (settings.go is concurrent WIP).
