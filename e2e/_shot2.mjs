...
const m=await p.evaluate(()=>{const w=document.querySelector('.bento .w'); const cardShadow=w?getComputedStyle(w).boxShadow:null; return {w:cardShadow};});
console.log("bento .w box-shadow:", m.w?m.w.slice(0,80):"none");
await p.screenshot({path:'e2e/screenshots/design_dashboard_after.png'});
await b.close();
