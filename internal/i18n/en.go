...
var english = Catalog{
	...
	"notifications.markAllReadAria":   "Mark every notification as read",
	"notifications.overdueOneDay":     "Overdue by 1 day.",
	"notifications.overdueDays":       "Overdue by %d days.",
	...
	"notifications.groupStale":        "%d accounts need a balance update",
	"notifications.groupBill":         "%d bills are due soon",
	"notifications.groupBudget":       "%d budgets need attention",
	"notifications.groupLowBal":       "%d accounts are running low",
	"notifications.groupLarge":        "%d large charges to review",
	"notifications.groupGeneric":      "%d similar reminders",
	"notifications.groupHint":         "Grouped to keep things tidy",
	"notifications.groupShow":         "Show all",
	"notifications.groupHide":         "Hide",
	"notifications.groupExpandAria":   "Show the %d grouped notifications",
	"notifications.groupDismissAll":   "Dismiss all",
	...
	"bills.negotiate":                    "Negotiate",
	"bills.negotiateTitle":               "Add a to-do with talking points to negotiate this bill down",
	"bills.negotiateTaskTitle":           "Negotiate %s down",
	...
	"subs.cancelSaveLine":                "Cancelling saves about %s a year.",
	...
	"budgets.autoPickAria":           "Include %s, suggested %s a month",
	...
	"budgets.notesHint":              "Why %s exists, or something to do about it later.",
	...
	// C597 replaced this with budgets.deleteConfirmHonest: the old copy claimed
	// irreversibility that Ctrl+Z disproves, and said nothing about the
	// transactions, which is the part people actually fear losing.
	...
	// Goal priority: planning order (sort + card chip + edit-form picker).
	"goals.sortPriority":       "Priority",
	"goals.priorityLabel":      "Priority",
	"goals.priorityNone":       "No priority",
	"goals.priorityHigh":       "High",
	"goals.priorityMedium":     "Medium",
	"goals.priorityLow":        "Low",
	"goals.priorityChipHigh":   "High priority",
	"goals.priorityChipMedium": "Medium priority",
	"goals.priorityChipLow":    "Low priority",
	"goals.priorityChipTitle":  "This goal's planning priority — set it in Edit.",
	// Goal-vs-goal comparison modal.
	"goalcompare.title":     "Compare goals",
	"goalcompare.button":    "Compare",
	"goalcompare.pick":      "Choose a goal…",
	"goalcompare.empty":     "Pick two goals to see their figures side by side.",
	"goalcompare.none":      "—",
	"goalcompare.goalA":     "First goal",
	"goalcompare.goalB":     "Second goal",
	"goalcompare.target":    "Target",
	"goalcompare.covered":   "Saved + set aside",
	"goalcompare.toGo":      "To go",
	"goalcompare.monthly":   "Monthly plan",
	"goalcompare.projected": "Projected landing",
	"goalcompare.deadline":  "Target date",
	"goalcompare.priority":  "Priority",
	// 30/60/90-day available-cash forecast widget.
	"dashboard.forecast":      "Cash forecast",
	"dashboard.forecast30":    "In 30 days",
	"dashboard.forecast60":    "In 60 days",
	"dashboard.forecast90":    "In 90 days",
	"dashboard.forecastSub":   "Projected from your recurring activity across available cash accounts (%s today).",
	"dashboard.forecastEmpty": "Add cash accounts and recurring items to project your balance forward.",
	// To-do checklist templates (month-end close, tax prep).
	"todo.checklistsMenu":      "Checklists",
	"todo.checklistsMenuTitle": "Add a checklist from a template",
	"todo.checklistMonthEnd":   "Month-end financial close",
	"todo.checklistTaxPrep":    "Tax preparation",
	"todo.checklistAdded":      "\"%s\" added with %d steps.",
	"todo.tmplMonthEnd":        "Month-end close — %s",
	"todo.tmplMEReconcile":     "Reconcile each cash account to its statement",
	"todo.tmplMEReview":        "Review uncategorized and unreviewed transactions",
	"todo.tmplMEBudgets":       "Review overspent budgets and cover them",
	"todo.tmplMEGoals":         "Record goal contributions and set-asides",
	"todo.tmplMEReports":       "Read the monthly report and note anything unusual",
	"todo.tmplTaxPrep":         "Tax preparation — %s",
	"todo.tmplTaxIncome":       "Gather income documents (pay stubs, 1099s)",
	"todo.tmplTaxDeductible":   "Mark tax-deductible transactions for the year",
	...
	// Report-to-action menu.
	"reports.actionsMenu":      "Turn into action",
	"reports.actionsMenuTitle": "Act on what this report showed",
	"reports.actionAddTask":    "Add a follow-up task",
	"reports.actionReview":     "Open the review inbox",
	...
	"goals.legendSaved":          "%s saved",
	"goals.legendSetAside":       "%s set aside",
	...
	"goals.paceWatch":                 "Watch",
	"goals.paceAtRisk":                "At risk",
	"goals.targetPlaceholder":         "Target (%s)",
	"goals.savedSoFar":                "Saved so far",
	"goals.totalTarget":               "Total target (goals)",
	"goals.headlineScope":             "Counts active and missed goals. Sinking funds (%s target) and achieved goals are listed below, not counted here.",
	...
	"widget.todayBadgeTitle":      "Current as of today — this figure doesn't follow the selected month.",
	"dashboard.netWorthAsOfToday": "as of today",
	...
	// Relative age plus wall-clock time: the relative part answers "is this recent?"
	// at a glance, the clock survives a render that has gone stale between ticks.
	"sync.agoJustNow":            "just now (%s)",
	"sync.agoMinutes":            "%dm ago (%s)",
	"sync.agoHours":              "%dh ago (%s)",
	"sync.agoDate":               "%s at %s",
	...
	"settings.dataExportHint":           "“Export JSON” backs up everything. “Export transactions (CSV)” saves your transactions only — use JSON for a full backup. “Export database” writes a real SQLite file you can open in other tools, and import back here.",
	...
	// The SQLite file export. Named for what it is rather than for the format,
	// because the reason to pick it is the destination — a spreadsheet, a script,
	// another program — not the file extension.
	"settings.exportSQLite":       "Export database (.sqlite)",
	"settings.importSQLite":       "Import database (.sqlite)…",
	...
	"settings.exportedSQLite":   "Saved your database to %s.",
	"settings.exportSQLiteErr":  "Couldn't export your database: %s",
	"settings.importedSQLite":   "Imported your database.",
	"settings.importSQLiteErr":  "Couldn't import that database: %s",
	// The import replaces everything, exactly like the JSON one, so it asks the
	// same question rather than a gentler variant of it.
	"settings.importSQLiteConfirm": "Importing a database replaces all current accounts, transactions, budgets, and goals on this device. This can't be undone.",
	...
	"transactions.moreActions":         "More",
	"transactions.filterShowAll":       "Show all %d",
	"transactions.filterShowLess":      "Show less",
	"transactions.filterSelected":      "· %d selected",
	...
	"transactions.upcomingHead":        "Upcoming this month · %d",
	"transactions.upcomingBadge":       "Upcoming",
	"transactions.upcomingNote":        "Scheduled from your bills & recurring — not posted yet, never counted in totals.",
	"transactions.upcomingMore":        "+%d more scheduled",
	"transactions.upcomingTitle":       "Open Bills & recurring to manage the schedule",
	...
	"accounts.liquidity":              "Easy to access (0–100)",
	"accounts.stability":              "Low risk (0–100)",
	"accounts.expReturnTitle":         "Expected return APR (%)",
	"accounts.liquidityTitle":         "How quickly you can withdraw this money (0 = locked away, 100 = instant).",
	"accounts.stabilityTitle":         "How safe this balance is from loss (0 = volatile, 100 = rock-solid).",
	...
	// --- The Annual Review (reports redesign) ---
	"rpta.eyebrow":                 "Annual review",
	"rpta.window":                  "%s — %s",
	...
	"rpta.kept":                    "Kept",
	"rpta.keptRate":                "%d%% of income kept this period",
	"rpta.factWindow3mo":           "last 3 months",
	"rpta.hhChip":                  "Household-wide",
	"rpta.hhChipTitle":             "This section always covers the whole household — it ignores the report's account scope.",
	"rpta.hhChipBudgetsTitle":      "Budgets are household-wide; the spending measured against them follows your scope.",
	"rpta.factorScopeNote":         "They are household-wide and ignore this report's account scope.",
	"rpta.factorBasisNote":         "Health factors measure where you stand right now (trailing averages, about the last three months) — they can differ from this report's full-period totals.",
	"rpta.overYear":                "over the year",
	"rpta.verdictExcellent":        "A strong year. The fundamentals are working — protect them and aim the surplus.",
	"rpta.verdictGood":             "A good year with room to push. The strengths below are real; the problem spots are fixable.",
	"rpta.verdictFair":             "A mixed year. What's working is listed first — the plan at the end targets what isn't.",
	"rpta.verdictNeedsWork":        "A hard year on paper. Start with the plan at the bottom; it's built from your actual numbers.",
	"rpta.verdictCritical":         "The numbers need attention now. Skip to the plan — it's ordered by impact.",
	"rpta.verdictNoData":           "Not enough history yet for a verdict — the review fills in as the year does.",
	"rpta.indexLabel":              "Report sections",
	"rpta.idxStrong":               "What's strong",
	"rpta.idxFlow":                 "Money flow",
	"rpta.idxMotion":               "The year in motion",
	"rpta.idxCats":                 "Categories",
	"rpta.idxWhere":                "Where it goes",
	"rpta.idxWatch":                "Watch list",
	"rpta.idxProblems":             "Problem spots",
	"rpta.idxPlan":                 "The plan",
	"rpta.secStrong":               "What's strong",
	"rpta.secStrongSub":            "The fundamentals that carried the year — keep these exactly as they are.",
	"rpta.noStrong":                "No factor scores in the healthy band yet — the plan below is where to start.",
	"rpta.winNoSpend":              "%d no-spend days",
	"rpta.winBestMonth":            "Best month: %s (+%s kept)",
	"rpta.winCut":                  "Cut %s by %s vs last year",
	"rpta.winGoals":                "%d goals reached",
	"rpta.winRunway":               "%d months of runway",
	"rpta.secFlowSub":              "A year of income fanning out into spending and savings — and what each $100 bought.",
	"rpta.nodeIncome":              "Income",
	"rpta.nodeOtherIncome":         "Other income",
	"rpta.nodeEverythingElse":      "Everything else",
	"rpta.nodeSavings":             "Savings",
	"rpta.flowAlt":                 "Money-flow diagram: income sources through income to spending categories and savings",
	"rpta.ofIncome":                "of income",
	"rpta.keySources":              "Income sources",
	"rpta.keyCats":                 "Spending categories",
	"rpta.keyWidth":                "Ribbon width = share of the year's money",
	"rpta.legendCash":              "Money kept each month (income − spending)",
	"rpta.legendSR":                "Share of each month's income kept",
	"rpta.legendNW":                "Total net worth at month end",
	"rpta.byTag":                   "Spending by tag",
	"rpta.weekdayHead":             "Spending by weekday",
	"rpta.legendWeekday":           "Total spent per weekday over the year — the heaviest day is amber",
	"rpta.ask":                     "Ask AI",
	"rpta.askTitle":                "Ask the assistant about \"%s\"",
	"rpta.askSeed":                 "I'm reading the \"%s\" section of my CashFlux Annual Review. Its observations: %s — Explain what's driving these numbers and what I should consider doing about them.",
	"rpta.histTableFold":           "The full category table — run rates, 12-month trends, and deltas",
	"rpta.secGoals":                "Goal progress",
	"rpta.secGoalsSub":             "Every financial goal's year: what's backed (moved + set aside) against its target.",
	"rpta.idxGoals":                "Goals",
	"rpta.goalBy":                  "by %s",
	"rpta.goalBacked":              "%s of %s backed (%d%%)",
	"rpta.goalStateCurrent":        "On the way",
	"rpta.goalStateReached":        "Reached",
	"rpta.goalStateMissed":         "Missed deadline",
	...
	"app.staleTabNotice":           "Your data was saved in another tab. Reload this tab to pick up the latest — changes here are no longer being saved.",
	...
	"rpta.nwSparkTitle":            "Net worth at each month end across the year",
	"rpta.nwSparkCap":              "12-month shape",
	...
	"rpta.budWithin":               "Within limit all year",
	"rpta.budMonthsOver":           "%d months over",
	"rpta.budOverYear":             "%s over the year's cap",
	"rpta.budAnnualized":           "(%s budget · vs full-year cap)",
	"rpta.budgetsSummary":          "%d of %d budgets stayed within their limit all year.",
	"rpta.budKeyUnder":             "Under limit",
	"rpta.budKeyNear":              "Within 10% over",
	"rpta.budKeyOver":              "Over limit",
	"rpta.openBudgets":             "Open Budgets",
	"rpta.creditHead":              "Credit score (estimated)",
	"rpta.legendCredit":            "CashFlux's credit proxy score at month end, 0–100 — not a bureau score",
	"rpta.probCosts":               "Money that bought nothing: %s in fees (%d charges) + %s in interest charges (%d)",
	"rpta.probFeesOnly":            "Money that bought nothing: %s in fees across %d charges",
	"rpta.probFeesOnlyOne":         "Money that bought nothing: %s in fees from a single charge",
	"rpta.probInterestOnly":        "Money that bought nothing: %s in interest charges across %d",
	"rpta.probInterestOnlyOne":     "Money that bought nothing: %s from a single interest charge",
	"rpta.costFee":                 "FEE",
	"rpta.costInterest":            "INTEREST",
	"rpta.costMore":                "+ %d more",
	"rpta.planFees":                "Stop paying fees — %s went to fees across %d charges",
	"rpta.planFeesOne":             "Stop paying fees — %s went to a fee this year",
	"rpta.planFeesDetail":          "Largest: %s (%s). Most fees are avoidable — autopay minimums, in-network ATMs, balance alerts.",
	"rpta.tagCharges":              "%d charges",
	"rpta.tagNew":                  "new",
	"rpta.tagOverlapNote":          "A charge can carry several tags, so tag totals overlap — they don't add up to total spending.",
	"rpta.per100Head":              "Where each $100 of income went",
	"rpta.per100Where":             "Where",
	"rpta.per100Year":              "Over the year",
	"rpta.secMotion":               "The year in motion",
	"rpta.secMotionSub":            "Every month reviewed: what came in, what went out, what stayed.",
	"rpta.colMonth":                "Month",
	"rpta.colKeptPct":              "Kept %",
	"rpta.seasonal":                "Heaviest month: %s (%s). Lightest: %s (%s).",
	"rpta.spendStats":              "%d purchases · average %s · median %s",
	"rpta.secCats":                 "Categories reviewed",
	"rpta.secCatsSub":              "Every category's year: total, monthly run-rate, trend, and how it moved vs the prior year.",
	"rpta.colYear":                 "Year",
	"rpta.colPerMonth":             "/month",
	"rpta.colTrend":                "12-month trend",
	"rpta.colVsPrior":              "vs prior yr",
	"rpta.colShare":                "Share",
	"rpta.newCat":                  "new",
	"rpta.secWhere":                "Where it actually goes",
	"rpta.secWhereSub":             "The year's biggest merchants, purchases, deposits, and sources — the concrete stuff behind the categories.",
	"rpta.secWatch":                "Watch list",
	"rpta.secWatchSub":             "Not problems yet — but trending the wrong way, or quietly compounding.",
	"rpta.watchClear":              "Nothing trending the wrong way this year.",
	"rpta.watchRising":             "Rising categories (first months vs last)",
	"rpta.watchSubs":               "%d recurring charges · ≈ %s a year",
	"rpta.watchRises":              "Price increases caught",
	"rpta.perYear":                 "%s/yr",
	"rpta.secProblems":             "Problem spots",
	"rpta.secProblemsSub":          "The numbers working against you — each one feeds an action in the plan below.",
	"rpta.probFactors":             "Health factors below the line",
	"rpta.monthsRed":               "months spent more than they earned",
	"rpta.negCashFlow":             "Cash flow is currently negative — spending is outrunning income.",
	"rpta.probDebt":                "Debt drag · ≈ %s of interest a year at current balances",
	"rpta.colDebt":                 "Liability",
	"rpta.colBalance":              "Balance",
	"rpta.colYearInterest":         "Est. interest/yr",
	"rpta.colMinimum":              "Minimum",
	"rpta.uncategorized":           "%d%% of spending (%s) is uncategorized — the review can only be as sharp as the data.",
	"rpta.missedGoals":             "%d goals missed their target date.",
	"rpta.noProblems":              "No structural problems found this year.",
	"rpta.secPlan":                 "The plan",
	"rpta.secPlanSub":              "Built from this year's numbers — each step sized in dollars, ordered by impact.",
	"rpta.planOpen":                "Open",
	"rpta.planTrim":                "Hold %s at about %s a month",
	"rpta.planTrimDetail":          "It has been running at %s a month recently — returning to its own median frees ≈ %s a year.",
	"rpta.planDebt":                "Send extra payments to %s first (%s APR)",
	"rpta.planDebtDetail":          "Every $1,000 paid down there avoids ≈ %s in interest a year.",
	"rpta.planSubs":                "Review %d recurring charges costing ≈ %s a year",
	"rpta.planSubsRises":           "%d of them raised prices this year.",
	"rpta.secAppendix":             "Appendix",
	"rpta.secAppendixSub":          "Tax-flagged totals, custom-field roll-ups, and the report's live variables.",
	"rpta.appendixFold":            "Show appendix (tax, custom fields, metrics)",
	// --- Summary vs. Full mode (executive review toggle) ---
	"rpta.modeSummary":              "Summary",
	"rpta.modeFull":                 "Full report",
	"rpta.modeSummaryTitle":         "A one-glance executive summary: score, top wins, top risks, next steps, and the core trends",
	"rpta.modeFullTitle":            "The complete annual review: every section, table, and the appendix",
	"rpta.sumStrengths":             "Top strengths",
	"rpta.sumRisks":                 "Top risks",
	"rpta.sumActions":               "Recommended actions",
	"rpta.sumTrends":                "Core trends",
	"rpta.sumNoWins":                "No standout wins for this period yet.",
	"rpta.sumNoRisks":               "No pressing risks — your health factors are all in good shape.",
	"rpta.sumNoActions":             "Nothing needs action right now. Keep it up.",
	"rpta.sumDebt":                  "Debt",
	"rpta.sumFullLink":              "See the full report for the evidence behind this summary →",
	"reports.drillTitleCat":         "See this category's transactions",
	...
	"accounts.staleDaysSuffix":      " · %dd",
	"accounts.staleNeverSuffix":     " · never",
	"accounts.staleDaysTitle":       "Balance last confirmed %d days ago — update it to keep net worth accurate",
	"accounts.staleNeverTitle":      "This balance has never been confirmed — update it to keep net worth accurate",
	...
	// Percent entry mode: type each part as a percentage of the whole.
	"splitEditor.modeAmounts":    "Amounts",
	"splitEditor.modePercents":   "Percentages",
	"splitEditor.percent":        "Percent",
	"splitEditor.pctLeft":        "%s%% left to assign",
	"splitEditor.pctOver":        "%s%% over 100%%",
	"splitEditor.badPercent":     "Enter a positive percentage for each split.",
	"splitEditor.pctMustBalance": "The percentages must add up to 100%.",
	"splitEditor.pctTooSmall":    "This amount is too small to split into those percentages.",
	// Goal landing range: the trajectory at 125% / 100% / 75% of the planned monthly.
	"goalscenarios.best":         "Best %s",
	"goalscenarios.expected":     "Expected %s",
	"goalscenarios.conservative": "Conservative %s",
	"goalscenarios.beyond":       "10+ yrs",
	"goalscenarios.title":        "Landing range: best assumes saving 25% more each month, conservative 25% less.",
	...
	"dashboard.updateBalances":       "Update balances",
	"dashboard.legendDrillTitle":     "See the transactions behind this slice",
	"dashboard.billDrillTitle":       "Open %s",
	"dashboard.acctDrillTitle":       "Jump to %s on the Accounts page",
	"dashboard.recentDrillTitle":     "Find this transaction in the ledger",
	"dashboard.updateBalancesTitle":  "Open Accounts — confirm or correct each balance, or mark them all updated.",
	"dashboard.freshChipTitle":       "Jump to %s on the Accounts page to confirm its balance.",
	...
	"todo.assignAnyone":      "Anyone",
	"todo.assignUnknown":     "(former member)",
	...
	"accounts.transferReceivedLabel":   "Received amount (%s) — optional",
	"accounts.transferReceivedHint":    "What actually landed, if your bank's rate differs from the saved one. Leave blank to use the saved rate.",
	"accounts.transferFeeLabel":        "Transfer fee (%s) — optional",
	"accounts.transferFeeHint":         "Recorded as a separate expense on the source account.",
	"accounts.transferInvalidExtra":    "Received amount and fee must be valid amounts (or left blank).",
	...
	// Reconciliation history + "reconciled through" status.
	"accounts.reconStmtDate":       "Statement closing date",
	"accounts.reconStmtDateHint":   "The date your statement ends — recorded as this account's \"reconciled through\" point.",
	"accounts.reconThrough":        "Reconciled through %s.",
