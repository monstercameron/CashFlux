...
var english = Catalog{
	...
	"budgets.topupCoverShow":         "Fund it from another budget",
	"budgets.topupCoverHide":         "Fund it from another budget",
	"budgets.topupCoverHint":         "Pull the amount from budgets that have room — split evenly across the ones you pick.",
