...
var english = Catalog{
	...
	"budgets.savingsDesc":            "Each goal's monthly contribution counts toward your budget. Adjust an amount to reach $0 to assign.",
	"budgets.savingsEmpty":           "No savings assigned yet. Set a monthly amount on a goal (or give it a target date) to budget toward it.",
	"budgets.savingsManageGoals":     "Manage goals",
	"budgets.savingsMonthlyAria":     "Monthly contribution",
