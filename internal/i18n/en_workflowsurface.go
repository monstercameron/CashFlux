...
var workflowSurfaceKeys = Catalog{
	...
	"wfs.insertVar":       "Insert any variable…",
	"wfs.tmplHint":        "Tip: drop a live figure into the text with {{safe_to_spend}} — any variable or formula works.",
	"wfs.condWarn":        "This condition can't run: %s",
	"wfs.runErr":          "Couldn't run: %s",
	"wfs.dryNeedsTxn":     "Nothing to preview against yet — add a transaction first.",
	"wfs.dryPreviewTxn":   "Previewed against your most recent transaction.",
	"wfs.nothingHead":     "Nothing to do",
	"wfs.actTransfer":     "Move money (transfer)",
	"wfs.transferFrom":    "From account",
	"wfs.transferTo":      "To account",
	"wfs.transferAmount":  "Amount (%s)",
	"wfs.bootNote":        "Runs by itself once a month when the app starts — it won't appear in the workflow list below.",
	"wfs.perEntitySep":    "— per budget / goal / account —",
