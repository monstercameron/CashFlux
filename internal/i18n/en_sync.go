...
var syncPageKeys = Catalog{
	...
	"sync.whatSyncs":       "What syncs: your full database (accounts, transactions, budgets, goals — everything) and your attached files. When a passcode lock is on, your data is encrypted on this device before it's uploaded, so the server only ever stores ciphertext.",
