...
var reviewInboxKeys = Catalog{
	...
	"review.rulesMade":          "Made %d rules — future charges from these merchants file themselves.",
	...
	"review.scanNoKey":     "Smart+ reads the merchants your rules and history could not place, and suggests a category for each. It needs an OpenAI key, and it only ever runs when you ask.",
	"review.scanConnect":   "Connect a key",
	...
	"review.pickAria":      "Select %s, %d charges",
	"review.expandAria":    "Show the charges from %s",
