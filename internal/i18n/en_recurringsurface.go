...
var recurringSurfaceKeys = Catalog{
	...
	"bills.smartHint":          "Pay bills on paydays: every bill you control gets grouped onto one of your paydays (never after its due date) and the paychecks carry balanced loads. Bills that must jump into an earlier paycheck are flagged to pay ahead once — after that the new cadence just repeats.",
	...
	"bills.smartChipLow":       "Lowest balance (60 days)",
	...
	"bills.smartAlreadyEven":   "Every bill you control already sits on a payday — nothing to regroup.",
	"bills.smartMovesHint":     "Your bills, grouped onto paydays — heaviest paycheck lighter by %s:",
	"bills.smartMovesEven":     "Your bills, grouped onto paydays (the heaviest check is autopay the plan can't touch):",
	"bills.smartBucketHead":    "Pay on %s — %d bill(s) · %s",
	"bills.smartMoveLine":      "Pay %s on your %s payday (due %s)",
	"bills.smartPayAhead":      "Pay ahead",
	"bills.payAheadHint":       "This payment jumps into an earlier paycheck than its due date's — front it once and the new cadence repeats from there (the flag clears once you've paid it).",
	...
	"bills.aheadTitle":         "%d payment(s) the plan moved to this payday",
	"bills.calLegendSmart":     "Showing the pay-on plan: accent dots are payments moved onto a payday; hollow dots are the raw due dates they left (check next month for bills paid ahead from there).",
	"bills.calLegendRaw":       "Showing raw due dates: hollow dots are where the pay-on plan would move payments.",
	...
	"bills.smartStatusOn":      "On — %d payment(s) grouped onto paydays, heaviest paycheck lighter by %s.",
	"bills.smartStatusOnEven":  "On — %d payment(s) grouped onto paydays, loads balanced.",
