...
var recurringSurfaceKeys = Catalog{
	...
	"bills.smartAlreadyEven":   "Your paychecks already carry the coming bills evenly — nothing to move.",
	"bills.smartMovesHint":     "Paying these ahead lightens your heaviest paycheck by %s:",
	"bills.smartMovesEven":     "Your heaviest paycheck can't move (those bills are on autopay), but paying these ahead spreads the rest evenly:",
	...
	"bills.smartStatusOn":      "On — %d payment(s) paid ahead, heaviest paycheck lighter by %s.",
	"bills.smartStatusOnEven":  "On — %d payment(s) paid ahead to spread the load evenly.",
