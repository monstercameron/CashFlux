...
var vaultSurfaceKeys = Catalog{
	...
	"artifacts.downloadTitle":    "Download this file",
	"artifacts.downloadEmpty":    "Couldn't download %q — its data isn't available on this device.",
	"artifacts.renameModalTitle": "Rename file",
}
