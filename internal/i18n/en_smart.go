...
var smartKeys = Catalog{
	...
	"smart.triageSevNudge":     "Nudges & up",
	"smart.triageSevWarn":      "Warnings & up",
	"smart.triageSevAlert":     "Alerts only",
	"smart.triagePageLabel":    "Page",
	"smart.triageAllPages":     "All pages",
	"smart.triageSortLabel":    "Sort",
	"smart.triageSortSeverity": "Most urgent first",
