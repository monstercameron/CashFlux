...
var reconcileSignKeys = Catalog{
	...
	"accounts.reconSignHintDebt":  "Enter the closing balance as it affects you: money you owe is a negative number, and a credit in your favour is positive. A statement showing $500.00 owed is entered as -500.",
