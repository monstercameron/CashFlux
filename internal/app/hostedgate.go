	...
	case hostedHydrationLocked:
		...
		body = Fragment(body,
			Div(css.Class("card", tw.Flex, tw.FlexCol, tw.Gap3),
				...
				uiw.Field(passcode.Get(), css.Class("set-input"), Type("password"), Attr("inputmode", "numeric"),
					Attr("aria-label", uistate.T("applock.passcode")),
					Attr("data-testid", "hosted-hydration-passcode"),
					Placeholder(uistate.T("applock.passcode")), OnInput(onPasscode)),
				uiw.Field(confirm.Get(), css.Class("set-input"), Type("password"), Attr("inputmode", "numeric"),
					Attr("aria-label", uistate.T("applock.confirm")),
					Attr("data-testid", "hosted-hydration-confirm"),
					Placeholder(uistate.T("applock.confirm")), OnInput(onConfirm)),
