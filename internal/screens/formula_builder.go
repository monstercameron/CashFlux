	...
	workbench := Div(css.Class("fb"),
		...
		Div(css.Class("fb-workbench"),
			...
			Div(css.Class("fb-exprbar"),
				uiw.Field(expr.Get(), css.Class("field", "fb-expr"), Type("text"), Attr("aria-label", uistate.T("customize.exprLabel")),
					Placeholder(uistate.T("customize.exprPlaceholder")), OnInput(onExpr)),
			...
			Form(css.Class("fb-save"), OnSubmit(saveFormula),
				uiw.Field(fName.Get(), css.Class("field", "fb-save-name"), Type("text"), Attr("aria-label", uistate.T("customize.nameLabel")),
					Placeholder(uistate.T("customize.savePlaceholder")), OnInput(onFName)),
		...
		Div(css.Class("fb-palette"),
			Div(css.Class("fb-pal-toolbar"),
				uiw.Field(search.Get(), css.Class("field", "fb-pal-search"), Type("search"),
