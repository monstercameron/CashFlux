		...
		Form(css.Class("form-grid rec-modal-form"), Attr("id", "recurring-form"), OnSubmit(save),
			labeledField(uistate.T("recurring.labelPlaceholder"),
				Input(css.Class("field"), Type("text"), Attr("data-testid", "rec-label"), Attr("autofocus", "true"),
					Placeholder(uistate.T("recurring.labelPlaceholder")), OnInput(onLabel), uiw.FieldValue(labelS.Get()))),
			...
			labeledField(uistate.T("recurring.amountLabel", base),
				...
				Input(css.Class("field"), Type("text"), Attr("inputmode", "decimal"), Attr("data-testid", "rec-amount"), OnInput(onAmount), uiw.FieldValue(amountS.Get()))),
			...
			Div(css.Class("rec-modal-wide"),
				labeledField(uistate.T("recurring.nextDueLabel"),
					Input(css.Class("field"), Type("date"), Attr("data-testid", "recurring-nextdue"),
						Attr("aria-label", uistate.T("recurring.nextDueLabel")), OnInput(onDue), uiw.FieldValue(dueS.Get())))),
