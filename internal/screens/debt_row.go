		...
		Div(css.Class("debt-side"),
			...
			Div(css.Class("debt-actions"),
				Button(css.Class("btn btn-sm", tw.InlineFlex, tw.ItemsCenter, tw.Gap15), Type("button"),
					Attr("data-testid", "debt-view-"+a.ID), Attr("aria-label", uistate.T("debt.viewAria", a.Name)),
				...
				Button(css.Class("btn btn-sm", tw.InlineFlex, tw.ItemsCenter, tw.Gap15), Type("button"),
					Attr("data-testid", "debt-edit-"+a.ID), Attr("aria-label", uistate.T("debt.editAria", a.Name)),
					Title(uistate.T("accounts.editTitle")), OnClick(edit),
				...
				Button(css.Class("btn btn-sm btn-ghost"), Type("button"), Attr("aria-pressed", ariaBool(props.InPayoff)),
					Attr("data-testid", "debt-payoff-toggle-"+a.ID), Attr("aria-label", uistate.T("debt.payoffToggleAria", a.Name)),
					Title(payoffLabel), OnClick(togglePay), Text(payoffLabel)),
			),
		),
	)
}
