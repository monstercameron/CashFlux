...
func All() []Route {
	return []Route{
		...
		{Path: "/loans", Label: "nav.loans", Title: "nav.loans", Subtitle: "screen.loansSub", Phase: 2, Group: GroupTools, SubGroup: SubGroupPlan, View: LoansScreen},
		...
		{Path: "/duplicates", Label: "nav.duplicates", Title: "nav.duplicates", Subtitle: "screen.duplicatesSub", Phase: 2, Group: GroupTools, SubGroup: SubGroupData, View: DuplicatesScreen},
		...
		// C21: Guided setup wizard — /setup — walks new users through currency, income,
		// first account, and household members. Lives in GroupSystem so it appears in
		// nav but is also reachable as a direct route from empty-state CTAs.
