	...
	return Div(css.Class("inv-pool-modal"),
		Form(css.Class("inv-pool-modal-form"), Attr("id", "invest-pool-form"), OnSubmit(save),
			labeledField(uistate.T("investments.poolNameLabel"),
				uiw.Field(nameS.Get(), css.Class("field"), Type("text"), Attr("data-testid", "pool-name"), Attr("autofocus", "true"),
					Placeholder(uistate.T("investments.poolNamePlaceholder")), OnInput(onName))),
