...
func Planning() ui.Node {
	...
	if app != nil {
		...
		plansCard = Section(Class("card"),
			...
			Form(Class("form-grid"), OnSubmit(addPlan),
				...
				Input(Class("field"), Type("number"), Attr("min", "1"), Title(uistate.T("plans.horizonTitle")), Attr("aria-required", "true"), Placeholder(uistate.T("plans.horizonPlaceholder")), Value(plHorizon.Get()), Step("1"), OnInput(onPlHorizon)),
				...
				Input(Class("field"), Type("number"), Attr("min", "1"), Attr("max", plHorizon.Get()), Title(uistate.T("plans.onceMonthTitle")), Placeholder(uistate.T("plans.onceMonthPlaceholder")), Value(plOnceMonth.Get()), Step("1"), OnInput(onPlOnceMonth)),
	...
	if app != nil {
		...
		debtCard = Section(Class("card"),
			...
			Form(Class("form-grid"),
				Input(Class("field"), Type("number"), Attr("min", "0"), Attr("aria-label", "Extra monthly payment"), Placeholder(uistate.T("planning.debtStrategyExtra", base)), Value(dsExtra.Get()), Step("0.01"), OnInput(onDsExtra)),
			),
	...
	return Div(
		...
		Section(Class("card"),
			...
			Form(Class("form-grid"),
				Input(Class("field"), Type("number"), Attr("min", "0"), Placeholder(uistate.T("planning.balancePlaceholder", base)), Value(balStr.Get()), Step("0.01"), OnInput(onBal)),
				Input(Class("field"), Type("number"), Attr("min", "0"), Placeholder(uistate.T("planning.aprPlaceholder")), Value(aprStr.Get()), Step("0.01"), OnInput(onApr)),
				Input(Class("field"), Type("number"), Attr("min", "0"), Placeholder(uistate.T("planning.paymentPlaceholder", base)), Value(payStr.Get()), Step("0.01"), OnInput(onPay)),
				Input(Class("field"), Type("number"), Attr("min", "0"), Placeholder(uistate.T("planning.extraPlaceholder", base)), Value(extraStr.Get()), Step("0.01"), OnInput(onExtra)),
			),
		),
		Section(Class("card"),
