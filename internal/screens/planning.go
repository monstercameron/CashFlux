...
func Planning() ui.Node {
	...
	if app != nil {
		...
		forecastCard = Section(Class("card"),
			...
			Form(Class("form-grid"),
				labeledField(uistate.T("planning.trimPlaceholder", base), Input(Class("field"), Type("number"), Value(trimStr.Get()), Step("0.01"), OnInput(onTrim))),
			),
			trimNote,
		)
	}
	...
	if app != nil {
		...
		affordCard = Section(Class("card"),
			...
			Form(Class("form-grid"),
				labeledField(uistate.T("planning.affordAmountPlaceholder", base), Input(Class("field"), Type("number"), Attr("min", "0"), Value(afAmount.Get()), Step("0.01"), OnInput(onAfAmount))),
				labeledField(uistate.T("planning.affordMonthsPlaceholder"), Input(Class("field"), Type("number"), Attr("min", "0"), Value(afMonths.Get()), Step("1"), OnInput(onAfMonths))),
				labeledField(uistate.T("planning.affordReservePlaceholder", base), Input(Class("field"), Type("number"), Attr("min", "0"), Value(afReserve.Get()), Step("0.01"), OnInput(onAfReserve))),
			),
			afBody,
		)
	}
	...
	if app != nil {
		...
		runwayCard = Section(Class("card"),
			...
			Form(Class("form-grid"),
				labeledField(uistate.T("planning.runwayBufferPlaceholder", base), Input(Class("field"), Type("number"), Attr("min", "0"), Value(rwBuffer.Get()), Step("0.01"), OnInput(onRwBuffer))),
			),
			rwBody,
		)
	}
	...
	if app != nil {
		...
		recurringCard = Section(Class("card"),
			...
			Form(Class("form-grid"), OnSubmit(addRecurring),
				...
				labeledField(uistate.T("recurring.amountPlaceholder", base), Input(Class("field"), Type("number"), Value(rAmount.Get()), Step("0.01"), OnInput(onRAmount))),
	...
	if app != nil {
		...
		plansCard = Section(Class("card"),
			...
			Form(Class("form-grid"), OnSubmit(addPlan),
				...
				labeledField(uistate.T("plans.horizonPlaceholder"), Input(Class("field"), Type("number"), Attr("min", "1"), Attr("aria-required", "true"), Value(plHorizon.Get()), Step("1"), OnInput(onPlHorizon))),
				labeledField(uistate.T("plans.startPlaceholder", base), Input(Class("field"), Type("number"), Value(plStart.Get()), Step("0.01"), OnInput(onPlStart))),
				labeledField(uistate.T("plans.monthlyPlaceholder", base), Input(Class("field"), Type("number"), Value(plMonthly.Get()), Step("0.01"), OnInput(onPlMonthly))),
				labeledField(uistate.T("plans.onceAmtPlaceholder", base), Input(Class("field"), Type("number"), Value(plOnceAmt.Get()), Step("0.01"), OnInput(onPlOnceAmt))),
				labeledField(uistate.T("plans.onceMonthPlaceholder"), Input(Class("field"), Type("number"), Attr("min", "1"), Attr("max", plHorizon.Get()), Value(plOnceMonth.Get()), Step("1"), OnInput(onPlOnceMonth))),
	...
	if app != nil {
		...
		debtCard = Section(Class("card"),
			...
			Form(Class("form-grid"),
				labeledField(uistate.T("planning.debtStrategyExtra", base), Input(Class("field"), Type("number"), Attr("min", "0"), Value(dsExtra.Get()), Step("0.01"), OnInput(onDsExtra))),
			),
	...
	return Div(
		...
		Section(Class("card"),
			...
			Form(Class("form-grid"),
				labeledField(uistate.T("planning.balancePlaceholder", base), Input(Class("field"), Type("number"), Attr("min", "0"), Value(balStr.Get()), Step("0.01"), OnInput(onBal))),
				labeledField(uistate.T("planning.aprPlaceholder"), Input(Class("field"), Type("number"), Attr("min", "0"), Value(aprStr.Get()), Step("0.01"), OnInput(onApr))),
				labeledField(uistate.T("planning.paymentPlaceholder", base), Input(Class("field"), Type("number"), Attr("min", "0"), Value(payStr.Get()), Step("0.01"), OnInput(onPay))),
				labeledField(uistate.T("planning.extraPlaceholder", base), Input(Class("field"), Type("number"), Attr("min", "0"), Value(extraStr.Get()), Step("0.01"), OnInput(onExtra))),
			),
		),
		Section(Class("card"),
