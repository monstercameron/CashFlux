		...
		addForm = Div(css.Class("card", tw.P3, tw.Mb3), Attr("data-testid", "event-add-form"),
			Div(css.Class(tw.Grid, tw.Gap2),
				...
				Input(css.Class("field"), Type("text"), Placeholder(uistate.T("events.namePh")),
					Attr("data-testid", "event-name"), OnInput(onName), uiw.FieldValue(nameS.Get())),
				Div(css.Class(tw.Flex, tw.Gap2),
					Div(css.Class(tw.Flex1),
						Label(css.Class("fctrl-label"), uistate.T("events.start")),
						Input(css.Class("field"), Type("date"), Attr("data-testid", "event-start"), OnInput(onStart), uiw.FieldValue(startS.Get()))),
					Div(css.Class(tw.Flex1),
						Label(css.Class("fctrl-label"), uistate.T("events.end")),
						Input(css.Class("field"), Type("date"), Attr("data-testid", "event-end"), OnInput(onEnd), uiw.FieldValue(endS.Get()))),
				),
				Span(css.Class("text-dim", tw.Text13), uistate.T("events.endHint")),
				Label(css.Class("fctrl-label"), uistate.T("events.note")),
				Input(css.Class("field"), Type("text"), Placeholder(uistate.T("events.notePh")), OnInput(onNote), uiw.FieldValue(noteS.Get())),
...
func eventRow(props eventRowProps) ui.Node {
	...
	if editing.Get() {
		return Div(css.Class("card", tw.P3), Attr("data-testid", "event-row-"+e.ID),
			Div(css.Class(tw.Grid, tw.Gap2),
				Input(css.Class("field"), Type("text"), OnInput(onName), uiw.FieldValue(nameS.Get())),
				Div(css.Class(tw.Flex, tw.Gap2),
					Input(css.Class("field", tw.Flex1), Type("date"), OnInput(onStart), uiw.FieldValue(startS.Get())),
					Input(css.Class("field", tw.Flex1), Type("date"), OnInput(onEnd), uiw.FieldValue(endS.Get())),
				),
				Input(css.Class("field"), Type("text"), Placeholder(uistate.T("events.notePh")), OnInput(onNote), uiw.FieldValue(noteS.Get())),
				If(errS.Get() != "", Div(css.Class("form-error"), Attr("role", "alert"), errS.Get())),
				Div(css.Class(tw.Flex, tw.Gap2),
