	...
	if adding.Get() {
		addForm = Div(css.Class("card", tw.P3, tw.Mb3), Attr("data-testid", "event-add-form"),
			Div(css.Class(tw.Grid, tw.Gap2),
				...
				uiw.Field(nameS.Get(), css.Class("field"), Type("text"), Placeholder(uistate.T("events.namePh")),
					Attr("data-testid", "event-name"), OnInput(onName)),
				Div(css.Class(tw.Flex, tw.Gap2),
					Div(css.Class(tw.Flex1),
						Label(css.Class("fctrl-label"), uistate.T("events.start")),
						uiw.Field(startS.Get(), css.Class("field"), Type("date"), Attr("data-testid", "event-start"), OnInput(onStart))),
					Div(css.Class(tw.Flex1),
						Label(css.Class("fctrl-label"), uistate.T("events.end")),
						uiw.Field(endS.Get(), css.Class("field"), Type("date"), Attr("data-testid", "event-end"), OnInput(onEnd))),
				),
				Span(css.Class("text-dim", tw.Text13), uistate.T("events.endHint")),
				Label(css.Class("fctrl-label"), uistate.T("events.note")),
				uiw.Field(noteS.Get(), css.Class("field"), Type("text"), Placeholder(uistate.T("events.notePh")), OnInput(onNote)),
...
func eventRow(props eventRowProps) ui.Node {
	...
	if editing.Get() {
		return Div(css.Class("card", tw.P3), Attr("data-testid", "event-row-"+e.ID),
			Div(css.Class(tw.Grid, tw.Gap2),
				uiw.Field(nameS.Get(), css.Class("field"), Type("text"), OnInput(onName)),
				Div(css.Class(tw.Flex, tw.Gap2),
					uiw.Field(startS.Get(), css.Class("field", tw.Flex1), Type("date"), OnInput(onStart)),
					uiw.Field(endS.Get(), css.Class("field", tw.Flex1), Type("date"), OnInput(onEnd)),
				),
				uiw.Field(noteS.Get(), css.Class("field"), Type("text"), Placeholder(uistate.T("events.notePh")), OnInput(onNote)),
				If(errS.Get() != "", Div(css.Class("form-error"), Attr("role", "alert"), errS.Get())),
				Div(css.Class(tw.Flex, tw.Gap2),
