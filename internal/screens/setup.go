		...
		Body: Form(css.Class("form-grid"), OnSubmit(confirmAccount),
			...
			labeledField(uistate.T("setup.acctTypeLabel"),
				Select(css.Class("field"),
					...
					OnChange(onAcctType),
					acctTypeOption(domain.TypeChecking, acctType, uistate.T("accounts.typeChecking")),
					acctTypeOption(domain.TypeSavings, acctType, uistate.T("accounts.typeSavings")),
					acctTypeOption(domain.TypeCash, acctType, uistate.T("accounts.typeCash")),
					acctTypeOption(domain.TypeCreditCard, acctType, uistate.T("accounts.typeCreditCard")),
					acctTypeOption(domain.TypeInvestment, acctType, uistate.T("accounts.typeInvestment")),
					acctTypeOption(domain.TypeOther, acctType, uistate.T("accounts.typeOther")),
				),
			),
