...
func SweepRulesForm(props SweepRulesFormProps) ui.Node {
	...
	return Form(css.Class(tw.Flex, tw.FlexCol, tw.Gap3), Attr("id", "sweep-rules-form"),
		...
		Div(css.Class("stu-mol-edit", tw.Flex, tw.FlexCol, tw.Gap2),
			Div(css.Class(tw.Flex, tw.Gap2, tw.FlexWrap, tw.ItemsCenter),
				Span(css.Class("t-caption"), uistate.T("acctSweepCfg.keep")),
				...
				Span(css.Class("t-caption"), uistate.T("acctSweepCfg.moveTo")),
			...
			Button(css.Class("btn btn-primary btn-sm"), Type("submit"),
