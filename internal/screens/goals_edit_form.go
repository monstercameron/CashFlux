				...
				labeledField(uistate.T("goals.contributeAmount"),
					Div(css.Class("contrib-amount-row"),
						Input(css.Class("field"), Attr("id", "goal-contrib-"+g.ID), Attr("autofocus", ""), Type("number"),
							Placeholder(uistate.T("goals.contributeAmount")), Step("0.01"), OnInput(onContrib), uiw.FieldValue(contribS.Get())),
						finishChip,
					)),
				ledgerRow,
				errLine,
		...
		Div(css.Class("modal-scroll"),
			labeledField(uistate.T("common.name"),
				Input(css.Class("field"), Attr("id", "goal-edit-"+g.ID), Attr("autofocus", ""), Type("text"),
					Placeholder(uistate.T("common.name")), OnInput(onName), uiw.FieldValue(nameS.Get()))),
			...
			If(financial, labeledField(uistate.T("goals.targetLabel"),
				Input(css.Class("field"), Type("number"), Placeholder(uistate.T("goals.targetLabel")), Step("0.01"), OnInput(onTarget), uiw.FieldValue(targetS.Get())))),
			If(financial, labeledField(uistate.T("goals.monthlyContribLabel"),
				Input(css.Class("field"), Type("number"), Attr("data-testid", "goal-edit-monthly"), Attr("min", "0"),
					Placeholder(uistate.T("goals.monthlyContribPlaceholder")), Step("0.01"), OnInput(onMonthly), uiw.FieldValue(monthlyS.Get())))),
			...
			If(financial, labeledField(uistate.T("goals.expectedReturnLabel"),
				Input(css.Class("field"), Type("number"), Attr("data-testid", "goal-edit-return"), Attr("min", "0"), Attr("max", "50"),
					Placeholder(uistate.T("goals.expectedReturnPlaceholder")), Step("0.1"), OnInput(onReturn), uiw.FieldValue(returnS.Get())))),
			...
			If(kind == domain.GoalKindHabit, labeledField(uistate.T("goals.habitTargetLabel"),
				Input(css.Class("field"), Type("number"), Attr("data-testid", "goal-edit-habit-target"), Placeholder(uistate.T("goals.habitTargetPlaceholder")), Step("1"), OnInput(onHabitTarget), uiw.FieldValue(habitTargetS.Get())))),
			labeledField(uistate.T("goals.dateLabel"),
				Input(css.Class("field"), Type("date"), Attr("aria-label", uistate.T("goals.dateLabel")), OnInput(onDate), uiw.FieldValue(dateS.Get()))),
