			...
			Div(css.Class("modal-scroll"),
				...
				labeledField(uistate.T("goals.contributeAmount"),
					Div(css.Class("contrib-amount-row"),
						uiw.NumField(contribS.Get(), css.Class("field"), Attr("id", "goal-contrib-"+g.ID), Attr("autofocus", ""), Type("number"),
							Placeholder(uistate.T("goals.contributeAmount")), Step("0.01"), OnInput(onContrib)),
						finishChip,
					)),
				ledgerRow,
				errLine,
	...
	return Form(css.Class("acct-edit-form"), OnSubmit(saveEdit),
		Div(css.Class("modal-scroll"),
			labeledField(uistate.T("common.name"),
				uiw.Field(nameS.Get(), css.Class("field"), Attr("id", "goal-edit-"+g.ID), Attr("autofocus", ""), Type("text"),
			...
			If(financial, labeledField(uistate.T("goals.targetLabel"),
				uiw.NumField(targetS.Get(), css.Class("field"), Type("number"), Placeholder(uistate.T("goals.targetLabel")), Step("0.01"), OnInput(onTarget)))),
			If(financial, labeledField(uistate.T("goals.monthlyContribLabel"),
				uiw.NumField(monthlyS.Get(), css.Class("field"), Type("number"), Attr("data-testid", "goal-edit-monthly"), Attr("min", "0"),
					Placeholder(uistate.T("goals.monthlyContribPlaceholder")), Step("0.01"), OnInput(onMonthly)))),
			...
			If(financial, labeledField(uistate.T("goals.expectedReturnLabel"),
				uiw.NumField(returnS.Get(), css.Class("field"), Type("number"), Attr("data-testid", "goal-edit-return"), Attr("min", "0"), Attr("max", "50"),
					Placeholder(uistate.T("goals.expectedReturnPlaceholder")), Step("0.1"), OnInput(onReturn)))),
			...
			If(kind == domain.GoalKindHabit, labeledField(uistate.T("goals.habitTargetLabel"),
				uiw.NumField(habitTargetS.Get(), css.Class("field"), Type("number"), Attr("data-testid", "goal-edit-habit-target"), Placeholder(uistate.T("goals.habitTargetPlaceholder")), Step("1"), OnInput(onHabitTarget)))),
			labeledField(uistate.T("goals.dateLabel"),
				uiw.Field(dateS.Get(), css.Class("field"), Type("date"), Attr("aria-label", uistate.T("goals.dateLabel")), OnInput(onDate))),
