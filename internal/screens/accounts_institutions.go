	...
	return Form(css.Class("acct-edit-form"), Attr("data-testid", "institution-edit-form"), OnSubmit(save),
		Div(css.Class("modal-scroll"),
			...
			labeledField(uistate.T("accounts.institutionNameLabel"),
				uiw.Field(nameS.Get(), css.Class("field"), Attr("id", "inst-name"), Attr("autofocus", ""), Attr("data-testid", "institution-name"),
					Type("text"), Placeholder(uistate.T("accounts.institutionNamePh")), OnInput(onName))),
			labeledField(uistate.T("accounts.institutionColorLabel"),
				Div(css.Class(tw.Flex, tw.ItemsCenter, tw.Gap2),
					uiw.Field(swatch, css.Class("color-input"), Type("color"), Attr("data-testid", "institution-color"),
						Attr("aria-label", uistate.T("accounts.institutionColorLabel")), OnInput(onColor)))),
			labeledField(uistate.T("accounts.institutionPhoneLabel"),
				uiw.Field(phoneS.Get(), css.Class("field"), Type("tel"), Attr("data-testid", "institution-phone"),
					Placeholder(uistate.T("accounts.institutionPhonePh")), OnInput(onPhone))),
			labeledField(uistate.T("accounts.institutionURLLabel"),
				uiw.Field(urlS.Get(), css.Class("field"), Type("url"), Attr("data-testid", "institution-url"),
					Placeholder(uistate.T("accounts.institutionURLPh")), OnInput(onURL))),
