	...
	form := Fragment(
		...
		Label(css.Class("fld-field"),
			...
			Input(css.Class("field"), Attr("placeholder", amtPlaceholder), Attr("aria-label", amtPlaceholder),
				Attr("inputmode", "decimal"), OnInput(onAmt), uiw.FieldValue(amtStr.Get())),
		),
		Label(css.Class("fld-field"),
	...
	return Div(css.Class("wf-quick-panel"),
		...
		Label(css.Class("fld-field"),
			...
			Input(css.Class("field"), Attr("placeholder", bufPlaceholder), Attr("aria-label", bufPlaceholder),
				Attr("inputmode", "decimal"), OnInput(onBuf), uiw.FieldValue(bufStr.Get())),
		),
		If(msg.Get() != "", P(css.Class("err"), Attr("role", "alert"), msg.Get())),
...
func addWorkflowForm(props addWorkflowFormProps) ui.Node {
		...
		paramControl = Fragment(
			...
			Label(css.Class("fld-field"),
				...
				Input(css.Class("field"), Attr("placeholder", amtLabel), Attr("aria-label", amtLabel),
					Attr("inputmode", "decimal"), OnInput(onDraftAmt), uiw.FieldValue(draftAmt.Get()))),
		)
		...
		paramControl = Fragment(
			Label(css.Class("fld-field"),
				...
				Textarea(css.Class("field"), Attr("rows", "3"),
					...
					Attr("aria-label", uistate.T("workflows.agentPromptLabel")), OnInput(onDraftText), uiw.FieldValue(draftText.Get()))),
	...
	default: // createTask / notify / addTag
		paramControl = Input(css.Class("field"), Attr("placeholder", uistate.T("workflows.actionText")),
			Attr("aria-label", uistate.T("workflows.actionText")), OnInput(onDraftText), uiw.FieldValue(draftText.Get()))
	}
	...
	return Div(css.Class("wf-composer"), Attr("data-testid", "wf-composer"),
		...
		fld(uistate.T("workflows.name"),
			Input(css.Class("field"), Attr("placeholder", uistate.T("workflows.name")), Attr("aria-label", uistate.T("workflows.name")), OnInput(onName), uiw.FieldValue(name.Get()))),
		...
		fld(uistate.T("workflows.conditionLabel"),
			Input(css.Class("field"), Attr("placeholder", uistate.T("wfs.condPlaceholder")), Attr("aria-label", uistate.T("workflows.conditionLabel")), OnInput(onCondition), uiw.FieldValue(condition.Get()))),
		...
		return Div(css.Class("row-edit"),
			Form(css.Class("form-grid"), OnSubmit(saveEdit),
				labeledField(uistate.T("workflows.name"),
					Input(css.Class("field"), Attr("aria-label", uistate.T("workflows.name")), OnInput(onEditName), uiw.FieldValue(editName.Get()))),
				labeledField(uistate.T("workflows.conditionLabel"),
					Input(css.Class("field"), Attr("aria-label", uistate.T("workflows.conditionLabel")), Placeholder(uistate.T("workflows.condition")), OnInput(onEditCond), uiw.FieldValue(editCond.Get()))),
