		...
		uiw.EntityListSection(uiw.EntityListSectionProps{
			...
			Body: Fragment(
				...
				Form(css.Class("form-grid"),
					labeledField(uistate.T("planning.balancePlaceholder", base), uiw.NumField(balStr.Get(), css.Class("field"), Type("number"), Attr("min", "0"), Step("0.01"), OnInput(onBal))),
					labeledField(uistate.T("planning.aprPlaceholder"), uiw.NumField(aprStr.Get(), css.Class("field"), Type("number"), Attr("min", "0"), Step("0.01"), OnInput(onApr))),
					labeledField(uistate.T("planning.paymentPlaceholder", base), uiw.NumField(payStr.Get(), css.Class("field"), Type("number"), Attr("min", "0"), Step("0.01"), OnInput(onPay))),
					labeledField(uistate.T("planning.extraPlaceholder", base), uiw.NumField(extraStr.Get(), css.Class("field"), Type("number"), Attr("min", "0"), Step("0.01"), OnInput(onExtra))),
				),
			),
		}),
		uiw.EntityListSection(uiw.EntityListSectionProps{
