...
func SampleDatasetAt(now time.Time) Dataset {
	...
	ds := Dataset{
		...
		Accounts: []domain.Account{
			...
			{ID: k401, Name: "Marcus's 401(k)", OwnerID: marcus, Scope: domain.ScopeIndividual, Class: domain.ClassAsset, Type: domain.TypeRetirement, Currency: "USD", OpeningBalance: usd(850000), BalanceAsOf: date(2026, time.March, 31), LiquidityScore: 40, StabilityScore: 55, ExpectedReturnAPR: 7.5},
			{ID: roth, Name: "Roth IRA", OwnerID: marcus, Scope: domain.ScopeIndividual, Class: domain.ClassAsset, Type: domain.TypeRetirement, Currency: "USD", OpeningBalance: usd(220000), BalanceAsOf: date(2026, time.March, 31), LiquidityScore: 45, StabilityScore: 60, ExpectedReturnAPR: 7.0},
			...
			{ID: mortgage, Name: "Mortgage", OwnerID: domain.GroupOwnerID, Scope: domain.ScopeShared, Class: domain.ClassLiability, Type: domain.TypeMortgage, Currency: "USD", OpeningBalance: usd(-24400000), BalanceAsOf: date(2026, time.July, 1), InterestRateAPR: domain.APR(4.1), DueDayOfMonth: 1, MinPayment: usd(148000), Lender: "Beacon Bank Home Loans", TermMonths: 360, OriginationDate: date(2019, time.September, 1)},
			{ID: carM, Name: "Marcus's Car Loan", OwnerID: marcus, Scope: domain.ScopeIndividual, Class: domain.ClassLiability, Type: domain.TypeLoan, Currency: "USD", OpeningBalance: usd(-3800000), BalanceAsOf: date(2026, time.June, 15), InterestRateAPR: domain.APR(7.4), DueDayOfMonth: 15, MinPayment: usd(62000), Lender: "Apex Auto Finance", TermMonths: 72, OriginationDate: date(2023, time.March, 15)},
			{ID: carP, Name: "Priya's Car Loan", OwnerID: priya, Scope: domain.ScopeIndividual, Class: domain.ClassLiability, Type: domain.TypeLoan, Currency: "USD", OpeningBalance: usd(-2600000), BalanceAsOf: date(2026, time.June, 17), InterestRateAPR: domain.APR(6.9), DueDayOfMonth: 17, MinPayment: usd(48000), Lender: "Apex Auto Finance", TermMonths: 60, OriginationDate: date(2024, time.January, 17)},
			...
			{ID: sloan, Name: "Priya's Student Loan", OwnerID: priya, Scope: domain.ScopeIndividual, Class: domain.ClassLiability, Type: domain.TypeLoan, Currency: "USD", OpeningBalance: usd(-3800000), BalanceAsOf: date(2026, time.June, 5), InterestRateAPR: domain.APR(5.5), DueDayOfMonth: 5, MinPayment: usd(32000), Lender: "EdFinance Servicing", TermMonths: 120, OriginationDate: date(2018, time.June, 5)},
			{ID: card, Name: "Rewards Credit Card", OwnerID: domain.GroupOwnerID, Scope: domain.ScopeShared, Class: domain.ClassLiability, Type: domain.TypeCreditCard, Currency: "USD", OpeningBalance: usd(-380000), BalanceAsOf: date(2026, time.June, 22), CreditLimit: usd(1500000), InterestRateAPR: domain.APR(24.99), DueDayOfMonth: 22, MinPayment: usd(22000), Lender: "Beacon Bank"},
			{ID: travelcard, Name: "Travel Card (EUR)", OwnerID: domain.GroupOwnerID, Scope: domain.ScopeShared, Class: domain.ClassLiability, Type: domain.TypeCreditCard, Currency: "EUR", OpeningBalance: eur(0), BalanceAsOf: date(2026, time.June, 20), CreditLimit: eur(300000), InterestRateAPR: domain.APR(19.9), Lender: "Wise"},
		},
		Categories: []domain.Category{
			...
			{ID: catHOA, Name: "HOA dues", Kind: domain.KindExpense, Color: "#2563eb", ParentID: catHousing, CategoryClass: domain.ClassFixed},
			{ID: catPropTax, Name: "Property tax", Kind: domain.KindExpense, Color: "#1d4ed8", ParentID: catHousing, CategoryClass: domain.ClassNonMonthly},
			{ID: catUtilities, Name: "Utilities", Kind: domain.KindExpense, Color: "#38bdf8"},
			{ID: catElectric, Name: "Electricity", Kind: domain.KindExpense, Color: "#0ea5e9", ParentID: catUtilities, CategoryClass: domain.ClassFixed},
			{ID: catInternet, Name: "Internet", Kind: domain.KindExpense, Color: "#0284c7", ParentID: catUtilities, CategoryClass: domain.ClassFixed},
			...
			{ID: catGas, Name: "Gas", Kind: domain.KindExpense, Color: "#8b5cf6", ParentID: catTransport, CategoryClass: domain.ClassFixed},
			{ID: catAutoLoan, Name: "Auto loans", Kind: domain.KindExpense, Color: "#7c3aed", ParentID: catTransport, CategoryClass: domain.ClassFixed},
			{ID: catInsurance, Name: "Insurance", Kind: domain.KindExpense, Color: "#f472b6", CategoryClass: domain.ClassFixed},
			...
			{ID: catSubs, Name: "Subscriptions", Kind: domain.KindExpense, Color: "#c084fc", CategoryClass: domain.ClassFixed},
		...
		Tasks: []domain.Task{
			...
			// Follow-ups pinned to a few budgets (Task.RelatedType=budget) — they surface in the
			// budget card's side panel, check-off in place. The Splurges budget carries two so a
			// card shows a note AND a to-do list side by side.
			{ID: "task-splurge-review", Title: "Review this quarter's splurges — are we overdoing it?", Status: domain.StatusOpen, Priority: domain.PriorityMedium, Due: date(2026, time.July, 20), RelatedType: domain.RelatedBudget, RelatedID: "bud-splurges", MemberID: priya, Source: domain.SourceAI},
			{ID: "task-splurge-wineclub", Title: "Cancel the wine club we impulse-signed-up for", Status: domain.StatusOpen, Priority: domain.PriorityLow, RelatedType: domain.RelatedBudget, RelatedID: "bud-splurges", MemberID: marcus, Source: domain.SourceManual},
			{ID: "task-groceries-mealplan", Title: "Meal-plan Sundays to trim the grocery bill", Status: domain.StatusOpen, Priority: domain.PriorityMedium, RelatedType: domain.RelatedBudget, RelatedID: "bud-groceries", MemberID: priya, Source: domain.SourceManual},
			// A budget with a LONG follow-up list (7) — models the side panel's cap + "+N more".
			{ID: "task-groceries-storebrand", Title: "Switch to store-brand staples (flour, canned, cereal)", Status: domain.StatusOpen, Priority: domain.PriorityLow, RelatedType: domain.RelatedBudget, RelatedID: "bud-groceries", MemberID: priya, Source: domain.SourceManual},
			{ID: "task-groceries-mealkit", Title: "Cancel the meal-kit subscription — it's cheaper to cook", Status: domain.StatusOpen, Priority: domain.PriorityMedium, Due: date(2026, time.July, 25), RelatedType: domain.RelatedBudget, RelatedID: "bud-groceries", MemberID: marcus, Source: domain.SourceAI},
			{ID: "task-groceries-bulk", Title: "Buy pantry staples in bulk at Costco", Status: domain.StatusOpen, Priority: domain.PriorityLow, RelatedType: domain.RelatedBudget, RelatedID: "bud-groceries", MemberID: priya, Source: domain.SourceManual},
			{ID: "task-groceries-cap", Title: "Set a $150/week grocery cap alert", Status: domain.StatusOpen, Priority: domain.PriorityMedium, RelatedType: domain.RelatedBudget, RelatedID: "bud-groceries", MemberID: marcus, Source: domain.SourceAI},
			{ID: "task-groceries-unitprice", Title: "Compare unit prices: Greenfield vs Costco", Status: domain.StatusDone, Priority: domain.PriorityLow, RelatedType: domain.RelatedBudget, RelatedID: "bud-groceries", MemberID: priya, Source: domain.SourceManual},
			{ID: "task-groceries-cashback", Title: "Route groceries to the 3% cash-back card", Status: domain.StatusDone, Priority: domain.PriorityLow, RelatedType: domain.RelatedBudget, RelatedID: "bud-groceries", MemberID: marcus, Source: domain.SourceManual},
			{ID: "task-transport-insurance", Title: "Shop around for cheaper car insurance at renewal", Status: domain.StatusOpen, Priority: domain.PriorityLow, Due: date(2026, time.August, 15), RelatedType: domain.RelatedBudget, RelatedID: "bud-transport", MemberID: marcus, Source: domain.SourceManual},
			{ID: "task-transport-done", Title: "Compared gas apps and set the cheapest station", Status: domain.StatusDone, Priority: domain.PriorityLow, RelatedType: domain.RelatedBudget, RelatedID: "bud-transport", MemberID: marcus, Source: domain.SourceManual},
