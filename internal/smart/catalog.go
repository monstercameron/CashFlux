...
var catalog = []Feature{
	...
	rule("SMART-A14", PageAccounts, "Credit-utilization crossing", "Say when a card's utilization moves from one band into another — and when it comes back down."),
	...
	rule("SMART-B16", PageBudgets, "Cadence mismatch", "Spot a monthly budget for spending that actually happens quarterly or yearly, and point at a sinking fund."),
