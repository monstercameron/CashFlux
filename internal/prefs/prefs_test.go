...
func TestNormalize(t *testing.T) {
	...
	keep := Prefs{WeekStart: WeekMonday, DateStyle: DateLong, Theme: ThemeLight, Accent: "#abc", Compact: true, Scale: 110, ServerURL: "http://127.0.0.1:8081", ServerToken: "dev-token"}
